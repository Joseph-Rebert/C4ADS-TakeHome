# entities-explorer Specification

## Purpose

Frontend explorer for sanctioned entities: renders API-provided entity records
in a table with loading/error states and server-side filtering by country and
entity_type.
